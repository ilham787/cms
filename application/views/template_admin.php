...
<link rel="stylesheet" crossorigin href="<?= site_url('assets/mazer/dist') ?>/assets/compiled/css/app.css">
<link rel="stylesheet" crossorigin href="<?= site_url('assets/mazer/dist') ?>/assets/compiled/css/app-dark.css">
<link rel="stylesheet" crossorigin href="<?= site_url('assets/mazer/dist') ?>/assets/compiled/css/iconly.css">
</head>
...
<body>
  ...
  <div id="app">
      ...
      <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
          <ul class="menu">
            ...
            <li class="sidebar-item has-sub sidebar-item <?php if ($menu == 'user') {
                                                            echo "active";
                                                          } ?>">
              ...
              <ul class="submenu ">
                <?php if ($this->session->userdata('level') == 'Admin') { ?>
                  <li class="submenu-item">
                    <a href="<?= site_url('admin/user') ?>" class="submenu-link">Data Pengguna</a>
                  </li>
                <?php } ?>
                <li class="submenu-item">
            ...
            <li class="sidebar-item <?php if ($menu == 'konfigurasi') {
              ...
              <?php if ($this->session->userdata('level') == 'Admin') { ?>
                <a href="<?= site_url('admin/konfigurasi') ?>" class='sidebar-link'>
    ...
    <script src="<?= site_url('assets/mazer/dist') ?>/assets/static/js/components/dark.js"></script>
    <script src="<?= site_url('assets/mazer/dist') ?>/assets/extensions/perfect-scrollbar/perfect-scrollbar.min.js"></script>


    <script src="<?= site_url('assets/mazer/dist') ?>/assets/compiled/js/app.js"></script>



    <!-- Need: Apexcharts -->
    <script src="<?= site_url('assets/mazer/dist') ?>/assets/extensions/apexcharts/apexcharts.min.js"></script>
    <script src="<?= site_url('assets/mazer/dist') ?>/assets/static/js/pages/dashboard.js"></script>
