	...
	<main class="main">
		<section id="team" class="team section">
			...
			<div class="container section-title" data-aos="fade-up">
				<h2 class="mb-3 mt-4">Welcome to Hamz77 land</h2>
				<div><span class="description-title"><?= $nama_kategori; ?></span></div>
						...
						<div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
							<div class="member">
								...
								<div class="member-info">
									...
									<a href="<?= base_url('home/artikel/' . $uu['slug']) ?>" class="btn btn-link mx-auto my-2">Baca Selengkapnya</a>
								</div>
							</div>
						</div>
					<?php } ?>
